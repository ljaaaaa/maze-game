...
public class Constants {
	...
	public static final Color PLAYER2_COLOR = new Color(0, 0, 150);
    	...
    	public static final int GRID_WIDTH = FRAME_WIDTH/30;
    	public static final int GRID_HEIGHT = FRAME_HEIGHT/30;
